 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListLinks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListLinks';
     ...
     * Sets self
     *
     * @param string $self Link to `LIST` session itself.
     *
     * @return $this
     */
     ...
     * Sets customer
     *
     * @param string $customer Link to the registered customer of this `LIST` session. Appears only if it was initialized with appropriate information.
     *
     * @return $this
     */
