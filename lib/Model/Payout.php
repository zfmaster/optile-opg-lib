...
class Payout implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'links' => '\Optile\Model\PayoutLinks',
        'timestamp' => '\DateTime',
        'operation' => 'string',
        'network' => 'string',
     ...
     * Gets links
     *
     * @return \Optile\Model\PayoutLinks
     */
     ...
     * Sets links
     *
     * @param \Optile\Model\PayoutLinks $links links
     *
     * @return $this
     */
     ...
     * Sets timestamp
     *
     * @param \DateTime $timestamp Date and time this `PAYOUT` was initiated at.
     *
     * @return $this
     */
     ...
     * Sets result_code
     *
     * @param string $result_code Result code of this `PAYOUT` that reflects current state. See list of all [Result Codes](https://www.optile.io/opg#294007).
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param \Optile\Model\Status $status Current status of this `PAYOUT`. See list of all [Status Codes](https://www.optile.io/opg#285186).
     *
     * @return $this
     */
     ...
     * Sets interaction
     *
     * @param \Optile\Model\Interaction $interaction Interaction advice for this `PAYOUT` according to its current state.
     *
     * @return $this
     */
     ...
     * Sets redirect
     *
     * @param \Optile\Model\Redirect $redirect If present, merchant is advised to redirect customer to corresponding redirect URL.  This will lead to either PSP web-site to complete initiated `PAYOUT` session, or it will be pointing to one of the merchants callback URLs from `LIST` session.
     *
     * @return $this
     */
