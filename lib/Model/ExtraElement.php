...
/**
 * ExtraElement Class Doc Comment
 *
 * @category Class
 * @package  Optile
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExtraElement implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExtraElement';
    ...
    protected static $swaggerTypes = [
        'text' => 'string',
        'checkbox' => '\Optile\Model\Checkbox'
    ];
     ...
     * Sets text
     *
     * @param string $text Descriptive text that should be displayed for this extra element.
     *
     * @return $this
     */
     ...
     * Sets checkbox
     *
     * @param \Optile\Model\Checkbox $checkbox checkbox
     *
     * @return $this
     */
