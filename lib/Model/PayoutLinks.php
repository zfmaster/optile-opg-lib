 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PayoutLinks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PayoutLinks';
     ...
     * Sets self
     *
     * @param string $self Link to `PAYOUT` operation itself.
     *
     * @return $this
     */
     ...
     * Sets customer
     *
     * @param string $customer Link to the registered customer. Appears only if `PAYOUT` refers a `CHARGE` with registered customer information.
     *
     * @return $this
     */
     ...
     * Sets account
     *
     * @param string $account Link to the registered account used for this `PAYOUT`.
     *
     * @return $this
     */
