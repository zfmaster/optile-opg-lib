...
class Mandate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'reference' => 'string',
        'creditor_id' => 'string',
        'authentication' => '\Optile\Model\MandateAuthentication'
    ];
     ...
     * Sets reference
     *
     * @param string $reference The SEPA mandate reference (aka Mandate ID) proposed by the merchant. It has to be unique in the scope of his `creditorId`.
     *
     * @return $this
     */
     ...
     * Sets creditor_id
     *
     * @param string $creditor_id The SEPA creditor ID of the merchant. It can also be configured for some PSP within a contract. In this case the parameter is optional. In case when PSP uses its own creditor ID it will be returned in response and via status notification.
     *
     * @return $this
     */
     ...
     * Gets authentication
     *
     * @return \Optile\Model\MandateAuthentication
     */
     ...
     * Sets authentication
     *
     * @param \Optile\Model\MandateAuthentication $authentication authentication
     *
     * @return $this
     */
