...
/**
 * AccountLinks Class Doc Comment
 *
 * @category Class
 * @description Collection of links to build the account form for this registered account and perform different actions with entered data.
 * @package  Optile
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountLinks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountLinks';
     ...
     * Sets self
     *
     * @param string $self URL to retrieve details about this registered account in context of initialized `LIST`.
     *
     * @return $this
     */
     ...
     * Sets operation
     *
     * @param string $operation URL where operation data should be submitted (POSTed), if customer has decided to pay with this account registration.
     *
     * @return $this
     */
     ...
     * Sets validation
     *
     * @param string $validation URL to submit partial account data for in-page validation of registered account if supported.
     *
     * @return $this
     */
     ...
     * Sets logo
     *
     * @param string $logo URL of payment network logo (image) for this account registration.
     *
     * @return $this
     */
     ...
     * Sets form
     *
     * @param string $form URL to retrieve a registered version of account form template. HTML snippet with account elements and message placeholders.
     *
     * @return $this
     */
     ...
     * Sets localized_form
     *
     * @param string $localized_form URL to retrieve localized representation of registered account form. Text placeholders are replaced by text in corresponding language, language is defined by `LIST` session.
     *
     * @return $this
     */
     ...
     * Sets preload_form
     *
     * @param string $preload_form If present, this URL points to the form for this payment account that has to be preloaded and initialised prior the rendering of this `LIST` session on the client side. Main goal is to accelerate rendering of the main form for this account.
     *
     * @return $this
     */
