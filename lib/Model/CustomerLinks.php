 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerLinks implements ModelInterface, ArrayAccess
{
     ...
     * Sets self
     *
     * @param string $self Link to this customer resource.
     *
     * @return $this
     */
     ...
     * Sets charge
     *
     * @param string $charge URL where recurring `CHARGE` data be submitted (POSTed).
     *
     * @return $this
     */
