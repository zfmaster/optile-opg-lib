...
/**
 * LongReference Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LongReference implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LongReference';
    ...
    {
        $this->container['essential'] = isset($data['essential']) ? $data['essential'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['essential'] === null) {
            $invalidProperties[] = "'essential' can't be null";
        }
     ...
     * Sets essential
     *
     * @param string $essential Essential part of payment's long reference. Max 32 chars.
     *
     * @return $this
     */
     ...
     * Sets extended
     *
     * @param string $extended Extended part of payment's long reference. Max 32 chars.
     *
     * @return $this
     */
     ...
     * Sets verbose
     *
     * @param string $verbose Verbose part of payment's long reference. Max 32 chars.
     *
     * @return $this
     */
