...
class Installments implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'original_payment' => '\Optile\Model\PaymentAmount',
        'plans' => '\Optile\Model\InstallmentsPlan[]'
    ];
    ...
    protected static $setters = [
        'original_payment' => 'setOriginalPayment',
        'plans' => 'setPlans'
    ];
    ...
    protected static $getters = [
        'original_payment' => 'getOriginalPayment',
        'plans' => 'getPlans'
    ];
    ...
    {
        $this->container['original_payment'] = isset($data['original_payment']) ? $data['original_payment'] : null;
    ...
    /**
     * Gets original_payment
     *
     * @return \Optile\Model\PaymentAmount
     */
    public function getOriginalPayment()
    {
        return $this->container['original_payment'];
    }

    /**
     * Sets original_payment
     *
     * @param \Optile\Model\PaymentAmount $original_payment Information about original payment.
     *
     * @return $this
     */
    public function setOriginalPayment($original_payment)
    {
        $this->container['original_payment'] = $original_payment;
     ...
     * Gets plans
     *
     * @return \Optile\Model\InstallmentsPlan[]
     */
     ...
     * Sets plans
     *
     * @param \Optile\Model\InstallmentsPlan[] $plans Collection of calculated installments plans what should be present to customer.
     *
     * @return $this
     */
